...
$mail->Host = 'yourhost';  					// Specify main and backup SMTP servers
...
$mail->setFrom('youremail', 'DELAYED DAYPLANS');
...
$mail->Body    = 	"WELL THIS IS WEIRD BUT IF YOU GOT THIS MESSAGE MEANS THAT YOU NEED TO SEND THE DAYPLAN BECAUSE THE TIME IS OVER! IF YOU GOT THIS MESSAGE IS BECAUSE YOU ARE TESTING THE NEW DAYPLAN SYSTEM, IF YOU DONT WANT TO GOT THIS EMAILS IN THE FUTURE, SEND AN EMAIL TO: <a href='mailto:youruser@yourdomain.com'>Juan Carlos Paz (IT - WEB DEVELOPER)</a><b><p>This is an autogenerated message from the new dayplan mail system.</p></b><br>";
$mail->AltBody = 'This is an autogenerated message from the new dayplan mail system.';
